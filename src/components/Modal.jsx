export default function Modal({ isOpen, onClose, title, children }) {
  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-white dark:bg-brand-950 rounded-t-3xl sm:rounded-2xl p-6 pb-12 sm:pb-6 shadow-2xl animate-slide-up border-t sm:border border-brand-100 dark:border-brand-800">
